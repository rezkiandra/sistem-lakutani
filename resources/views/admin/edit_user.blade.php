    ...
    <div class="flex flex-col items-center justify-center w-full max-w-6xl">
      ...
      <div class="mb-8 text-center">
        <h2 class="text-2xl font-bold text-slate-800 flex items-center justify-center gap-2">
          <i class="ti ti-edit text-3xl text-slate-600"></i>
          Ubah Data Pengguna
        </h2>
        <p class="text-sm text-slate-800 mt-1">Perbarui data profil atau atur ulang kata sandi milik pengguna ini.</p>
      </div>

      <div class="bg-white border border-slate-200 rounded-xl p-6 md:p-8 shadow-sm w-full max-w-2xl text-left">
        <form action="{{ route('admin.updateUser', Crypt::encryptString($user->id)) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="grid grid-cols-1 gap-5">
            ...
            <div>
              ...
              <p class="text-xs text-slate-400 mt-0.5">Kosongkan kolom di bawah ini jika tidak ingin mengubah kata sandi
                pengguna.</p>
            </div>
