      ...
      <div class="card bg-base-200 mb-4">
        <div class="card-header woodImage p-5">
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-3xl font-bold text-slate-100 mb-1">🏡 Dashboard Administrator</h1>
              <span class="text-sm text-slate-100">Selamat datang, {{ Auth::user()->name }} —
                {{ now()->isoFormat('dddd, D MMMM YYYY') }}</span>
            </div>
            <div class="flex gap-2">
              <a href="{{ route('petani.catatKeuangan') }}" class="btn btn-success">
          ...
          <div class="card-body p-0">
            <div class="flex items-center justify-between border-b border-base-content/10 px-4 py-3">
              <div class="flex items-center gap-2">
                ...
                <h3 class="font-semibold">Grafik Keuangan Bulanan</h3>
              </div>
        ...
        <div class="card bg-base-100 shadow-md">
          <div class="card-body p-0">
            <div class="flex items-center gap-2 border-b border-base-content/10 px-4 py-3">
              <span class="icon-[tabler--users] text-primary size-5"></span>
              <h3 class="font-semibold">Statistik Pengguna</h3>
            </div>
        ...
        <div class="card bg-base-100 shadow-md">
          <div class="card-body p-0">
            <div class="flex items-center gap-2 border-b border-base-content/10 px-4 py-3">
              ...
              <h3 class="font-semibold">Ringkasan Usaha Tani</h3>
            </div>
            <div class="p-4">
              <div class="rounded-lg bg-base-200/60 p-3 text-sm flex flex-col gap-2">
                ...
                <div class="flex justify-between font-bold">
                  ...
                  <span class="{{ $rataLaba >= 0 ? 'text-success' : 'text-error' }}">
            ...
            <div class="overflow-x-auto">
              <table class="table table-sm">
                ...
                <tbody>
                  ...
                  @empty
                    <tr>
                      <td colspan="5" class="text-center text-base-content/40 py-6">Belum ada pengguna.</td>
                    </tr>
                  @endforelse
                </tbody>
              </table>
            ...
            <div class="p-4 flex flex-col gap-3">
              @forelse ($aktivitasTerbaru as $aktivitas)
                <div class="flex items-start gap-3">
                  <div
                    class="mt-0.5 size-7 rounded-full flex items-center justify-center shrink-0
                    {{ $aktivitas['tipe'] === 'produksi' ? 'bg-warning/20' : ($aktivitas['tipe'] === 'keuangan' ? 'bg-success/20' : 'bg-primary/20') }}">
                    <span
                      class="size-3.5
                      {{ $aktivitas['tipe'] === 'produksi' ? 'icon-[tabler--wheat] text-warning' : ($aktivitas['tipe'] === 'keuangan' ? 'icon-[tabler--cash] text-success' : 'icon-[tabler--user] text-primary') }}">
                    </span>
                  </div>
                  <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium leading-tight">{{ $aktivitas['pesan'] }}</p>
