      ...
      <div class="card bg-base-200">
        <div class="card-header woodImage p-5">
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-3xl font-bold text-slate-100 mb-1">✏️ Edit Produksi</h1>
              <span class="text-sm text-slate-100">Perbarui data hasil panen dan alokasi padi</span>
            </div>
            <a href="{{ route('petani.produksi') }}" class="btn btn-sm btn-ghost text-slate-100">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('petani.updateProduksi', $produksi->id) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div>
                      ...
                      <div class="input flex items-center">
                        <input type="number" name="hasil_panen_padi_kg" id="hasil_panen_padi_kg" class="grow"
                          step="0.01" min="0"
                          value="{{ old('hasil_panen_padi_kg', $produksi->hasil_panen_padi_kg) }}"
                          ...
                          <tr>
                            ...
                            <td>
                              <input type="number" name="{{ $item['name'] }}" class="input input-sm w-full alokasi"
                                step="0.01" min="0" value="{{ old($item['name'], $produksi->{$item['name']}) }}"
                                placeholder="0">
                            </td>
                          </tr>
                        @endforeach
                    ...
                    <div>
                      ...
                      <div class="input flex items-center">
                        ...
                        <input type="number" name="padi_terjual_kg" id="padi_terjual_kg" class="grow" step="0.01"
                          min="0" value="{{ old('padi_terjual_kg', $produksi->padi_terjual_kg) }}" placeholder="0"
                          required>
                        <span class="text-base-content/50 text-sm">kg</span>
                      </div>
                    ...
                    <div>
                      ...
                      <div class="input flex items-center">
                        ...
                        <input type="number" name="beras_terjual_kg" id="beras_terjual_kg" class="grow"
                          step="0.01" min="0"
                          value="{{ old('beras_terjual_kg', $produksi->beras_terjual_kg) }}" placeholder="0">
                        <span class="text-base-content/50 text-sm">kg</span>
                      </div>
                    </div>
                  </div>
            ...
            <div class="flex items-center justify-between mt-3 gap-2">
              <a href="{{ route('petani.produksi') }}" class="btn w-1/2">
                <span class="icon-[tabler--arrow-left] size-4"></span>
                Kembali
              </a>
