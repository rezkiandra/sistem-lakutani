    ...
    <div class="w-3/4 mt-20">
      <div class="card bg-base-200">
        <div class="card-header woodImage p-5">
          <h1 class="text-3xl font-bold text-slate-100 mb-1">📊 Input Laba / Rugi</h1>
          <span class="text-sm text-slate-100">Langkah 3 dari 3 — isi data pengeluaran produksi</span>
        </div>
        ...
        <ol class="mb-0 flex items-center gap-2 p-5">
          ...
          <li class="flex items-center gap-2">
            ...
            <span class="text-sm font-semibold text-dark">Laba / Rugi</span>
          </li>
        </ol>
        ...
        <div class="card-body">
          ...
          <form action="{{ route('petani.storeLabaRugi', $pendapatan->id) }}" method="POST">
                ...
                <div class="card bg-base-100 shadow-md">
                  <div class="card-body p-0">
                    <div class="flex items-center gap-2 border-b border-base-content/10 px-4 py-3">
                      ...
                      <h3 class="font-semibold">Input Usaha Tani</h3>
                    </div>
                    <div class="p-4 flex flex-col gap-3">
                      ...
                      @foreach ([['name' => 'benih', 'label' => 'Benih'], ['name' => 'urea', 'label' => 'Urea'], ['name' => 'tsp_sp36', 'label' => 'TSP / SP36'], ['name' => 'pupuk_lainnya', 'label' => 'Pupuk Lainnya'], ['name' => 'bahan_kimia', 'label' => 'Bahan Kimia']] as $item)
                        <div>
                          <label class="label-text mb-1" for="{{ $item['name'] }}">{{ $item['label'] }}</label>
                          <div class="input flex items-center">
                            <input type="number" name="{{ $item['name'] }}" id="{{ $item['name'] }}"
                              class="grow biaya-input" step="0.01" min="0" value="{{ old($item['name'], 0) }}"
                              placeholder="0">
                ...
                <div class="card bg-base-100 shadow-md">
                  <div class="card-body p-0">
                    <div class="flex items-center gap-2 border-b border-base-content/10 px-4 py-3">
                      ...
                      <h3 class="font-semibold">Pengeluaran Lain Produksi</h3>
                    </div>
                    <div class="p-4 flex flex-col gap-3">
                ...
                <div class="card bg-base-100 shadow-md">
                  <div class="card-body p-0">
                    <div class="flex items-center gap-2 border-b border-base-content/10 px-4 py-3">
                      ...
                      <h3 class="font-semibold">Biaya Panen</h3>
                    </div>
                    <div class="p-4 flex flex-col gap-3">
                    ...
                    <div class="p-4 flex flex-col gap-3">
                      ...
                      @foreach ([['name' => 'sewa_lahan', 'label' => 'Sewa Lahan'], ['name' => 'asuransi', 'label' => 'Asuransi']] as $item)
                        <div>
                          ...
                          <div class="input flex items-center">
                            <input type="number" name="{{ $item['name'] }}" id="{{ $item['name'] }}"
                              class="grow biaya-input" step="0.01" min="0"
              ...
              <div class="card bg-base-100 shadow-md lg:col-span-2">
                <div class="card-body p-0">
                  <div class="flex items-center gap-2 border-b border-base-content/10 px-4 py-3">
                    ...
                    <h3 class="font-semibold">Ringkasan Laba / Rugi</h3>
                  </div>
                  <div class="p-4">
                    <div class="rounded-lg bg-base-200/60 p-3 text-sm">
            ...
            <div class="flex items-center justify-between mt-3 gap-2">
              <a href="{{ route('petani.createPendapatan', $pendapatan->produksi->id) }}" class="btn w-1/2">← Kembali</a>
              <button type="submit" class="btn w-1/2 greenImage">Simpan & Selesai</button>
            </div>
