  ...
  <div class="container mx-auto text-center pt-16 min-h-screen flex items-center justify-center">
    <div class="flex flex-col items-center justify-center">
      ...
      <div class="grid grid-cols-2 gap-8 text-stone-200">
        <div
          class="flex flex-row items-center justify-center gap-8 shadow-2xl rounded-lg p-6 greenImage hover:scale-101 transition duration-300 ease-in-out transform cursor-pointer hover:shadow-3xl">
        ...
        <div
          class="flex flex-row items-center justify-center gap-8 shadow-2xl rounded-lg p-6 woodImage hover:scale-101 transition duration-300 ease-in-out transform cursor-pointer hover:shadow-3xl">
      ...
      <div class="pt-16">
        <button
          class="btn greenImage border-green-800 text-2xl px-10 py-8 text-stone-200 hover:scale-101 transition duration-300 ease-in-out transform cursor-pointer hover:shadow-3xl">Gabung
          Koperasi</button>
      </div>
    </div>
  </div>
